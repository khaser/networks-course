...
2. Какому устройству соответствует значение Ethernet-адреса?
   ...
   - Моей wifi сетевой карте
     ```
       5: wlp2s0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc noqueue state UP mode DORMANT group default qlen 1000
        link/ether ac:fd:ce:fb:cf:fc brd ff:ff:ff:ff:ff:ff
     ```
3. Каково значение исходного Ethernet-адреса? Какое устройство имеет такой Ethernet-адрес?
   - Address: 74:da:88:da:0d:28
   - Адрес роутера
4. Каков адрес назначения в этом Ethernet-кадре? Это Ethernet-адрес вашего компьютера?
   - Address: ac:fd:ce:fb:cf:fc
   - Да, это MAC адрес моего компьютера
<img src="images/eth_req.png" width=700 />
<img src="images/eth_resp.png" width=700 />
