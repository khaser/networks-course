...
Таким, образом, редуцируя неравенство: $\frac{\mu \cdot RSS \cdot R}{1500} <= n$.
Подставив конкретные значения, получим: $\frac{0.98 \cdot 30 ms \cdot 1 Gb/s}{1500 B} = 2450$. Таким образом
