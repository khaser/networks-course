...
#### Демонстрация работы
Перед запуском сервера необходимо проделать процедуру из README.md.
Далее его можно запустить следующей командой,
которую необходимо исполнять в директории `lab03`:
```
nix --experimental-features 'nix-command flakes' run '.#server' -- server_port concurrency_level
```
![server_log](images/server_log.png)
![ff_success](images/ff_success.png)
![ff_fail](images/ff_fail.png)
...
#### Демонстрация работы
Перед запуском клиента необходимо проделать процедуру из README.md.
Далее его можно запустить следующей командой,
которую необходимо исполнять в директории `lab03`:
```
